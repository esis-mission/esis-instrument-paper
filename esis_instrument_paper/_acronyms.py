...
def acronyms() -> list[aastex.Acronym]:
    ...
    return [
        ...
        aastex.Acronym("SPICE", "Spectral Imaging of the Coronal Environment"),
        aastex.Acronym("SNIFS", "Solar eruptioN Integral Field Spectrograph"),
        aastex.Acronym("MaGIXS", "Marshall Grazing Incidence X-ray Spectrometer"),
