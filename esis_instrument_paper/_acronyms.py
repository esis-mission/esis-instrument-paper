...
def acronyms() -> list[aastex.Acronym]:
    ...
    return [
        ...
        aastex.Acronym("TRACE", "the Transition Region and Coronal Explorer"),
        ...
        aastex.Acronym("SPICE", "the Spectral Imaging of the Coronal Environment"),
        aastex.Acronym("SNIFS", "the Solar eruptioN Integral Field Spectrograph"),
        aastex.Acronym("MaGIXS", "the Marshall Grazing Incidence X-ray Spectrometer"),
