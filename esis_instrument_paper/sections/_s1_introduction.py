...
The upcoming \MUSE\ \citep{DePontieu2020} mission addresses this problem in yet another way by using
...
and line widths of \TR\ explosive events as a function of time and space while \citet{Rust17} recovered splitting and
